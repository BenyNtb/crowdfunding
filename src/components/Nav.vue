    ...
    <header class="header">
        <div class="hero">
            <nav class="navbar">
                ...
                <svg width="16" height="15" xmlns="http://www.w3.org/2000/svg" class="nav-menu-hamburger">
                    <g fill="#FFF" class="hamburger-svg" fill-rule="evenodd">
                        <path d="M0 0h16v3H0zM0 6h16v3H0zM0 12h16v3H0z" />
                    </g>
                </svg>


                <span class="nav-menu-close">
                    <svg width="14" height="15" xmlns="http://www.w3.org/2000/svg">
                        <g class="active-nav-menu-close" fill="#FFF" fill-rule="evenodd">
...
.hero {
    ...
    /* box-shadow: inset 0px 20px 200px black;   */
...
.nav-menu.active {
    ...
    width: 100%;
    padding:  0rem 0rem; 
    filter: drop-shadow(0px 5px 400px rgba(0, 0, 0, 0.7 ));
